...
//-----------------------------UYGA VAZIFA BOSHLANDI-------------------------
    ...
    public void exercise2() {
        ...
        //List<Order> orders = orderRepo.findAll();
        List<Product> products = productRepo.findAll();
        List<Product> yourSolution = products.stream()
                .filter(prod -> prod.getCategory().equalsIgnoreCase("Baby"))
                .collect(Collectors.toList());
        System.out.println("Expected: "+expected);
        System.out.println("My Logic: "+yourSolution);
    }
    ...
    public void exercise3() {
        ...
        List<Product> yourSolution = productRepo.findAll().stream()
    ...
    public void exercise4_1() {
        ...
        List<Order> yourSolution = orderRepo.findAll().stream()
                .filter(customer -> customer.getCustomer().getTier()==2)
                .filter(customer -> customer.getOrderDate().isAfter(LocalDate.of(2021,2,1)))
                .filter(customer -> customer.getOrderDate().isBefore(LocalDate.of(2021,4,1)))
                .collect(Collectors.toList());
        System.out.println("Expected: "+expected);
        System.out.println("My Logic: "+yourSolution);
    ...
    public void exercise4_2() {
        ...
        List<String> yourSolution = orderRepo.findAll().stream()
    ...
    public void exercise9() {
        ...
        double yourSolution = orderRepo.findAll().stream()
                .filter(order -> order.getOrderDate().isEqual(LocalDate.of(2021,3,12)))
                .flatMap(order -> order.getProducts().stream())
                .mapToDouble(Product::getPrice)
                .average().getAsDouble();
        System.out.println("Expected: "+expected);
        String formatter = String.format("%.2f", yourSolution);
        System.out.println("My Logic: "+formatter);
    }
    ...
    public void exercise10() {
        ...
        DoubleSummaryStatistics yourSolution = productRepo.findAll().stream()
                .filter(product -> product.getCategory().equalsIgnoreCase("Books"))
                .mapToDouble(Product::getPrice)
                .summaryStatistics();
        System.out.println("Expected: "+expected);
    ...
    public void exercise7() {
        ...
        List<Product> yourSolution = orderRepo.findAll().stream()
